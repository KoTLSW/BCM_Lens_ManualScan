...
//            [self WriteLine:@":SENS:CURR:RANG 2E-6" andCommunicateType:communicateType];usleep(50*1000);
            ...
            [self WriteLine:@":SENS:RES:NPLC 0.1" andCommunicateType:communicateType];usleep(50*1000);
